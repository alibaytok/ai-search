...
Mini-V2 then failed on 7 of 12 cases. That is useful evidence. It shows the gate
...
| UPG-004 | `expected_field_drift` | 1 | matrix reconciliation |
...
If one more small technical packet were chosen, `UPG-004` is the narrowest
because it is matrix reconciliation rather than parser-core expansion. But even
that is optional.
