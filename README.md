...
- Mini-V2 admitted: 5/12 passing, 7 failing, 4 proposal groups
...
- [`harness/mini_v2_runs/L0-WS-MINI-V2-AUTONOMOUS-RUN-v1.report.json`](harness/mini_v2_runs/L0-WS-MINI-V2-AUTONOMOUS-RUN-v1.report.json)
