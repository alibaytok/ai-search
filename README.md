...
- Mini-V2 admitted: 6/12 passing, 6 failing, 3 proposal groups
...
- [`harness/mini_v2_runs/L0-WS-MINI-V2-AUTONOMOUS-RUN-v2.report.json`](harness/mini_v2_runs/L0-WS-MINI-V2-AUTONOMOUS-RUN-v2.report.json)
